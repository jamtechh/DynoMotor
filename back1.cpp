...
int main(int argc, char* argv[]) {
    ...
    bodies[1] = std::make_unique<RigidBody>(sys, file_names[1], 7850.00 / (1e9), true); // motor
    bodies[2] = std::make_unique<RigidBody>(sys, file_names[2], 7850.00 / (1e9));
    bodies[3] = std::make_unique<RigidBody>(sys, file_names[3], 7850.00 / (1e9));
    bodies[4] = std::make_unique<RigidBody>(sys, file_names[4], 7850.00 / (1e9), true); // frame
    bodies[5] = std::make_unique<RigidBody>(sys, file_names[5], 7850.00 / (1e9));bodies[5]->setColor(ChColor(0,1,0));
    bodies[6] = std::make_unique<RigidBody>(sys, file_names[6], 7850.00 / (1e9));
    bodies[7] = std::make_unique<RigidBody>(sys, file_names[7], 7850.00 / (1e9));
    bodies[8] = std::make_unique<RigidBody>(sys, file_names[8], 7850.00 / (1e9));
    bodies[9] = std::make_unique<RigidBody>(sys, file_names[9], 7850.00 / (1e9));
    bodies[10] = std::make_unique<RigidBody>(sys, file_names[10], 7850.00 / (1e9), true);   // dyno
